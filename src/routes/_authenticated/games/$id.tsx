...
const TABS: Array<{ to: "/games/$id" | "/games/$id/selections" | "/games/$id/delegation" | "/games/$id/competitions" | "/games/$id/accreditations" | "/games/$id/logistics" | "/games/$id/volunteers"; label: string; exact?: boolean }> = [
