...
INSERT INTO public.federation_members
  ...
  ('11111111-0000-0000-0000-000000000001','Pol','Mellina',    'Président',    'pol.mellina@fla.lu',          '+352 621 11 01 01', true, '2022-01-15'),
  ('11111111-0000-0000-0000-000000000001','Anne','Reuland',   'Secrétaire',   'a.reuland@fla.lu',            '+352 621 11 01 02', true, '2023-03-01'),
  ('11111111-0000-0000-0000-000000000001','Marc','Theis',     'Trésorier',    'm.theis@fla.lu',              '+352 621 11 01 03', true, '2023-03-01'),
  ('11111111-0000-0000-0000-000000000002','Marc','Hostert',   'Président',    'marc.hostert@flns.lu',        '+352 621 11 02 01', true, '2021-06-01'),
  ('11111111-0000-0000-0000-000000000002','Sophie','Klein',   'Vice-président','s.klein@flns.lu',            '+352 621 11 02 02', true, '2022-09-01'),
  ('11111111-0000-0000-0000-000000000003','Camille','Schwartz','Président',   'camille.schwartz@fscl.lu',    '+352 621 11 03 01', true, '2020-04-15'),
  ('11111111-0000-0000-0000-000000000003','Jean','Wagner',    'Secrétaire',   'j.wagner@fscl.lu',            '+352 621 11 03 02', true, '2023-01-10'),
  ('11111111-0000-0000-0000-000000000004','Jeannot','Reuter', 'Président',    'jeannot.reuter@fljudo.lu',    '+352 621 11 04 01', true, '2019-11-20'),
  ('11111111-0000-0000-0000-000000000005','Pascale','Hoffmann','Président',   'pascale.hoffmann@flt.lu',     '+352 621 11 05 01', true, '2022-05-15'),
  ('11111111-0000-0000-0000-000000000005','Tom','Klein',      'Trésorier',    't.klein@flt.lu',              '+352 621 11 05 02', true, '2023-02-01'),
  ('11111111-0000-0000-0000-000000000006','Jean-Marc','Bertemes','Président', 'jm.bertemes@flta.lu',         '+352 621 11 06 01', true, '2021-09-01'),
  ('11111111-0000-0000-0000-000000000007','Sophie','Klein',   'Président',    'sophie.klein@fltri.lu',       '+352 621 11 07 01', true, '2020-03-12'),
  ('11111111-0000-0000-0000-000000000008','Romain','Wagner',  'Président',    'romain.wagner@fls.lu',        '+352 621 11 08 01', true, '2018-12-01'),
  ('11111111-0000-0000-0000-000000000009','Tania','Folscheid','Président',    'tania.folscheid@flsg.lu',     '+352 621 11 09 01', true, '2022-02-20'),
  ('11111111-0000-0000-0000-000000000010','Luc','Theis',      'Président',    'luc.theis@fltt.lu',           '+352 621 11 10 01', true, '2021-04-05'),
  ('11111111-0000-0000-0000-000000000011','Patrick','Frising','Président',    'patrick.frising@flbb.lu',     '+352 621 11 11 01', true, '2020-08-15'),
  ('11111111-0000-0000-0000-000000000012','Paul','Philipp',   'Président',    'paul.philipp@flf.lu',         '+352 621 11 12 01', true, '2017-05-01'),
  ('11111111-0000-0000-0000-000000000013','Marc','Dax',       'Président',    'marc.dax@flvb.lu',            '+352 621 11 13 01', true, '2022-06-10'),
  ('11111111-0000-0000-0000-000000000014','Romain','Hoffmann','Président',    'romain.hoffmann@flh.lu',      '+352 621 11 14 01', true, '2021-01-15'),
  ('11111111-0000-0000-0000-000000000015','Charel','Stelmes', 'Président',    'charel.stelmes@flgym.lu',     '+352 621 11 15 01', true, '2019-10-01');
