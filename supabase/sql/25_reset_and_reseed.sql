-- ============================================================================
-- BF-RESET-001 — Reset complet des données + reseed mockup (v2)
-- ----------------------------------------------------------------------------
-- Objectif : nettoyer toute trace de développement et recréer un jeu de
-- données complet et cohérent avec les nouvelles contraintes :
--   - clubs.federation_id désormais nullable (migration 24)
--   - federation_members / club_members (migrations 13 / 14)
--   - logos & photos d'entités (migrations 21 / 22 / 23)
--   - adresses étendues (migrations 18 / 19)
-- ----------------------------------------------------------------------------
-- IMPORTANT : les comptes COSL (auth.users + public.user_profiles) sont
-- préservés. Tout le reste est purgé puis ré-inséré.
-- ============================================================================

BEGIN;

-- ============================================================================
-- 0. WIPE — Tout sauf user_profiles / auth.users
-- ----------------------------------------------------------------------------
-- TRUNCATE ... RESTART IDENTITY CASCADE : repart de zéro, FK propagées.
-- ============================================================================
TRUNCATE TABLE
  public.athlete_results,
  public.athlete_disciplines,
  public.athlete_appointments,
  public.athlete_documents,
  public.athlete_relations,
  public.athlete_kyc,
  public.kyc_history,
  public.accreditation_documents,
  public.accreditations,
  public.accreditation_types,
  public.flight_passengers,
  public.flights,
  public.rooming_assignments,
  public.accommodations,
  public.local_transport_passengers,
  public.local_transports,
  public.travel_plans,
  public.delegation_members,
  public.delegations,
  public.selections,
  public.game_quotas,
  public.game_competitions,
  public.game_sport_disciplines,
  public.game_sports,
  public.games,
...
-- ============================================================================
-- PALMARES / GAME_COMPETITIONS / ATHLETE_RESULTS (ex-seed_palmares.sql)
-- ============================================================================

-- Préfixes UUID :
--   ee = game_competitions
--   ff = athlete_results
-- Références :
--   sports     22222222-0000-0000-0000-0000000000XX
--   disciplines 33333333-0000-0000-0000-0000000000XX
--   athletes   66666666-0000-0000-0000-0000000000XX
--   games      77777777-0000-0000-0000-0000000000XX
--     ...01 JPEE 2027 (preparation)
--     ...05 JOJ Dakar 2026 (finished)

-- ============================================================================
-- 1. NETTOYAGE
-- ============================================================================
DELETE FROM public.athlete_results;
DELETE FROM public.game_competitions;
DELETE FROM public.athlete_disciplines;

-- ============================================================================
-- 2. GAME_COMPETITIONS
-- ============================================================================
-- JOJ Dakar 2026 (terminé) - épreuves disputées
INSERT INTO public.game_competitions
  (id, game_id, sport_id, discipline_id, name, competition_date, round, gender, category, venue) VALUES
  ('eeeeeeee-0000-0000-0000-000000000001','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','100m Hommes - Finale',         '2026-09-06','Finale',       'male',  'Senior','Stade Léopold Sédar Senghor'),
  ('eeeeeeee-0000-0000-0000-000000000002','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000002','100m Femmes - Finale',         '2026-09-06','Finale',       'female','Senior','Stade Léopold Sédar Senghor'),
  ('eeeeeeee-0000-0000-0000-000000000003','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000005','5000m Hommes - Finale',        '2026-09-09','Finale',       'male',  'Senior','Stade Léopold Sédar Senghor'),
  ('eeeeeeee-0000-0000-0000-000000000004','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000010','Saut en hauteur Femmes',       '2026-09-11','Finale',       'female','Senior','Stade Léopold Sédar Senghor'),
  ('eeeeeeee-0000-0000-0000-000000000005','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000011','50m libre Hommes - Finale',    '2026-09-07','Finale',       'male',  'Senior','Piscine Olympique Diamniadio'),
  ('eeeeeeee-0000-0000-0000-000000000006','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000014','100m libre Femmes - Finale',   '2026-09-08','Finale',       'female','Senior','Piscine Olympique Diamniadio'),
  ('eeeeeeee-0000-0000-0000-000000000007','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000015','200m papillon Hommes - Demi',  '2026-09-10','Demi-finale',  'male',  'Senior','Piscine Olympique Diamniadio'),
  ('eeeeeeee-0000-0000-0000-000000000008','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000017','4x100m relais mixte - Finale', '2026-09-12','Finale',       'mixed', 'Senior','Piscine Olympique Diamniadio'),
  ('eeeeeeee-0000-0000-0000-000000000009','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000018','Course en ligne Hommes',       '2026-09-13','Finale',       'male',  'Senior','Circuit de Dakar'),
  ('eeeeeeee-0000-0000-0000-000000000010','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000019','Course en ligne Femmes',       '2026-09-13','Finale',       'female','Senior','Circuit de Dakar'),
  ('eeeeeeee-0000-0000-0000-000000000011','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000004',NULL,                                   'Judo -73kg Hommes',            '2026-09-14','Finale',       'male',  '-73kg', 'Dakar Arena'),
  ('eeeeeeee-0000-0000-0000-000000000012','77777777-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000007',NULL,                                   'Triathlon individuel Hommes',  '2026-09-15','Finale',       'male',  'Senior','Lac Rose'),

-- JPEE 2027 Andorre (préparation) - épreuves prévues
  ('eeeeeeee-0000-0000-0000-000000000020','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','100m Hommes',                  '2027-05-30','Finale',       'male',  'Senior','Estadi Comunal Andorre'),
  ('eeeeeeee-0000-0000-0000-000000000021','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000002','100m Femmes',                  '2027-05-30','Finale',       'female','Senior','Estadi Comunal Andorre'),
  ('eeeeeeee-0000-0000-0000-000000000022','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000007','Marathon Hommes',              '2027-06-03','Finale',       'male',  'Senior','Andorre-la-Vieille'),
  ('eeeeeeee-0000-0000-0000-000000000023','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000013','100m libre Hommes',            '2027-05-31','Finale',       'male',  'Senior','Centre Aquatique Andorre'),
  ('eeeeeeee-0000-0000-0000-000000000024','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000018','Cyclisme route Hommes',        '2027-06-02','Finale',       'male',  'Senior','Vallée d''Andorre'),
  ('eeeeeeee-0000-0000-0000-000000000025','77777777-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000005',NULL,                                   'Tennis simple Hommes',         '2027-06-04','Finale',       'male',  'Senior','Andorra Tennis Club');

-- ============================================================================
-- 3. ATHLETE_RESULTS — palmarès JOJ Dakar 2026 + résultats hors-Games
-- ============================================================================
INSERT INTO public.athlete_results
  (id, athlete_id, game_id, game_competition_id, sport_id, discipline_id, result_date, rank, medal, score, unit, is_national_record, is_personal_best, notes) VALUES
  -- Athlétisme JOJ Dakar
  ('ffffffff-0000-0000-0000-000000000001','66666666-0000-0000-0000-000000000001','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','2026-09-06',3,'bronze','10.18','s', true,  true,  'Record national 100m Hommes'),
  ('ffffffff-0000-0000-0000-000000000002','66666666-0000-0000-0000-000000000002','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','2026-09-06',6,NULL,    '10.42','s', false, true,  'Personal best'),
  ('ffffffff-0000-0000-0000-000000000003','66666666-0000-0000-0000-000000000003','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000001','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','2026-09-06',8,NULL,    '10.55','s', false, false, NULL),
  ('ffffffff-0000-0000-0000-000000000004','66666666-0000-0000-0000-000000000005','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000002','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000002','2026-09-06',1,'gold',  '11.04','s', true,  true,  'Médaille d''or - Record national'),
  ('ffffffff-0000-0000-0000-000000000005','66666666-0000-0000-0000-000000000006','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000002','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000002','2026-09-06',5,NULL,    '11.42','s', false, false, NULL),
  ('ffffffff-0000-0000-0000-000000000006','66666666-0000-0000-0000-000000000004','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000003','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000005','2026-09-09',2,'silver','13:45.21','min:s',false,true, 'Personal best - argent 5000m'),
  ('ffffffff-0000-0000-0000-000000000007','66666666-0000-0000-0000-000000000007','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000004','22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000010','2026-09-11',4,NULL,    '1.88','m', false, true,  'Personal best saut hauteur'),

  -- Natation JOJ Dakar
  ('ffffffff-0000-0000-0000-000000000010','66666666-0000-0000-0000-000000000009','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000011','2026-09-07',1,'gold',  '21.78','s', true,  true,  'Record national 50m libre - Or'),
  ('ffffffff-0000-0000-0000-000000000011','66666666-0000-0000-0000-000000000010','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000005','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000011','2026-09-07',7,NULL,    '22.45','s', false, false, NULL),
  ('ffffffff-0000-0000-0000-000000000012','66666666-0000-0000-0000-000000000012','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000006','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000014','2026-09-08',2,'silver','54.12','s', false, true,  'Argent 100m libre Femmes'),
  ('ffffffff-0000-0000-0000-000000000013','66666666-0000-0000-0000-000000000013','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000006','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000014','2026-09-08',5,NULL,    '55.88','s', false, false, NULL),
  ('ffffffff-0000-0000-0000-000000000014','66666666-0000-0000-0000-000000000011','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000007','22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000015','2026-09-10',4,NULL,    '1:58.32','min:s',false,true,'Demi-finale 200m papillon'),

  -- Cyclisme JOJ Dakar
  ('ffffffff-0000-0000-0000-000000000020','66666666-0000-0000-0000-000000000015','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000009','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000018','2026-09-13',3,'bronze','4:12:08','h:min:s',false,false,'Bronze course en ligne Hommes'),
  ('ffffffff-0000-0000-0000-000000000021','66666666-0000-0000-0000-000000000016','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000009','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000018','2026-09-13',12,NULL,   '4:14:55','h:min:s',false,false,NULL),
  ('ffffffff-0000-0000-0000-000000000022','66666666-0000-0000-0000-000000000018','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000010','22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000019','2026-09-13',6,NULL,    '3:48:22','h:min:s',false,true, 'Personal best'),

  -- Judo JOJ Dakar
  ('ffffffff-0000-0000-0000-000000000030','66666666-0000-0000-0000-000000000021','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000011','22222222-0000-0000-0000-000000000004',NULL,'2026-09-14',3,'bronze',NULL,NULL, false, false, 'Médaille de bronze -73kg'),

  -- Triathlon JOJ Dakar
  ('ffffffff-0000-0000-0000-000000000031','66666666-0000-0000-0000-000000000033','77777777-0000-0000-0000-000000000005','eeeeeeee-0000-0000-0000-000000000012','22222222-0000-0000-0000-000000000007',NULL,'2026-09-15',9,NULL,'1:52:14','h:min:s',false,true,'Top 10 triathlon'),

  -- Résultats hors Games (championnats nationaux 2025/2026)
  ('ffffffff-0000-0000-0000-000000000040','66666666-0000-0000-0000-000000000001',NULL,NULL,'22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000001','2025-06-15',1,'gold','10.21','s', false, false, 'Championnat national LUX 100m'),
  ('ffffffff-0000-0000-0000-000000000041','66666666-0000-0000-0000-000000000005',NULL,NULL,'22222222-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000002','2025-06-15',1,'gold','11.18','s', false, false, 'Championnat national LUX 100m F'),
  ('ffffffff-0000-0000-0000-000000000042','66666666-0000-0000-0000-000000000009',NULL,NULL,'22222222-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000011','2025-12-10',1,'gold','21.89','s', false, false, 'Championnat national hiver natation'),
  ('ffffffff-0000-0000-0000-000000000043','66666666-0000-0000-0000-000000000015',NULL,NULL,'22222222-0000-0000-0000-000000000003','33333333-0000-0000-0000-000000000018','2025-08-22',2,'silver','3:58:14','h:min:s',false,false,'Championnat national cyclisme route'),
  ('ffffffff-0000-0000-0000-000000000044','66666666-0000-0000-0000-000000000021',NULL,NULL,'22222222-0000-0000-0000-000000000004',NULL,'2025-11-08',1,'gold',NULL,NULL,false,false,'Championnat national judo -73kg'),
  ('ffffffff-0000-0000-0000-000000000045','66666666-0000-0000-0000-000000000031',NULL,NULL,'22222222-0000-0000-0000-000000000006',NULL,'2025-09-20',3,'bronze','672','points',false,true,'Championnat national tir à l''arc');

-- ============================================================================
-- 4. ATHLETE_DISCIPLINES — disciplines secondaires (BF-ATH-013)
-- ============================================================================
INSERT INTO public.athlete_disciplines (athlete_id, discipline_id) VALUES
  -- Athlètes 100m qui font aussi du 200m
  ('66666666-0000-0000-0000-000000000001','33333333-0000-0000-0000-000000000003'),
  ('66666666-0000-0000-0000-000000000002','33333333-0000-0000-0000-000000000003'),
  ('66666666-0000-0000-0000-000000000005','33333333-0000-0000-0000-000000000004'),
  ('66666666-0000-0000-0000-000000000006','33333333-0000-0000-0000-000000000004'),
  -- 5000m + Marathon
  ('66666666-0000-0000-0000-000000000004','33333333-0000-0000-0000-000000000007'),
  -- Nageurs polyvalents
  ('66666666-0000-0000-0000-000000000009','33333333-0000-0000-0000-000000000013'),
  ('66666666-0000-0000-0000-000000000009','33333333-0000-0000-0000-000000000017'),
  ('66666666-0000-0000-0000-000000000012','33333333-0000-0000-0000-000000000016'),
  ('66666666-0000-0000-0000-000000000012','33333333-0000-0000-0000-000000000017'),
  ('66666666-0000-0000-0000-000000000013','33333333-0000-0000-0000-000000000017'),
  -- Cyclistes
  ('66666666-0000-0000-0000-000000000015','33333333-0000-0000-0000-000000000019'),
  ('66666666-0000-0000-0000-000000000018','33333333-0000-0000-0000-000000000018');


-- ============================================================================
-- FEDERATION_MEMBERS (nouveau — migration 13)
-- ============================================================================
INSERT INTO public.federation_members
  (federation_id, first_name, last_name, role, email, phone, is_active, start_date) VALUES
  ('11111111-0000-0000-0000-000000000001','Pol','Mellina',    'president',         'pol.mellina@fla.lu',          '+352 621 11 01 01', true, '2022-01-15'),
  ('11111111-0000-0000-0000-000000000001','Anne','Reuland',   'secretary_general', 'a.reuland@fla.lu',            '+352 621 11 01 02', true, '2023-03-01'),
  ('11111111-0000-0000-0000-000000000001','Marc','Theis',     'treasurer',         'm.theis@fla.lu',              '+352 621 11 01 03', true, '2023-03-01'),
  ('11111111-0000-0000-0000-000000000002','Marc','Hostert',   'president',         'marc.hostert@flns.lu',        '+352 621 11 02 01', true, '2021-06-01'),
  ('11111111-0000-0000-0000-000000000002','Sophie','Klein',   'vice_president',    's.klein@flns.lu',             '+352 621 11 02 02', true, '2022-09-01'),
  ('11111111-0000-0000-0000-000000000003','Camille','Schwartz','president',        'camille.schwartz@fscl.lu',    '+352 621 11 03 01', true, '2020-04-15'),
  ('11111111-0000-0000-0000-000000000003','Jean','Wagner',    'secretary_general', 'j.wagner@fscl.lu',            '+352 621 11 03 02', true, '2023-01-10'),
  ('11111111-0000-0000-0000-000000000004','Jeannot','Reuter', 'president',         'jeannot.reuter@fljudo.lu',    '+352 621 11 04 01', true, '2019-11-20'),
  ('11111111-0000-0000-0000-000000000005','Pascale','Hoffmann','president',        'pascale.hoffmann@flt.lu',     '+352 621 11 05 01', true, '2022-05-15'),
  ('11111111-0000-0000-0000-000000000005','Tom','Klein',      'treasurer',         't.klein@flt.lu',              '+352 621 11 05 02', true, '2023-02-01'),
  ('11111111-0000-0000-0000-000000000006','Jean-Marc','Bertemes','president',      'jm.bertemes@flta.lu',         '+352 621 11 06 01', true, '2021-09-01'),
  ('11111111-0000-0000-0000-000000000007','Sophie','Klein',   'president',         'sophie.klein@fltri.lu',       '+352 621 11 07 01', true, '2020-03-12'),
  ('11111111-0000-0000-0000-000000000008','Romain','Wagner',  'president',         'romain.wagner@fls.lu',        '+352 621 11 08 01', true, '2018-12-01'),
  ('11111111-0000-0000-0000-000000000009','Tania','Folscheid','president',         'tania.folscheid@flsg.lu',     '+352 621 11 09 01', true, '2022-02-20'),
  ('11111111-0000-0000-0000-000000000010','Luc','Theis',      'president',         'luc.theis@fltt.lu',           '+352 621 11 10 01', true, '2021-04-05'),
  ('11111111-0000-0000-0000-000000000011','Patrick','Frising','president',         'patrick.frising@flbb.lu',     '+352 621 11 11 01', true, '2020-08-15'),
  ('11111111-0000-0000-0000-000000000012','Paul','Philipp',   'president',         'paul.philipp@flf.lu',         '+352 621 11 12 01', true, '2017-05-01'),
  ('11111111-0000-0000-0000-000000000013','Marc','Dax',       'president',         'marc.dax@flvb.lu',            '+352 621 11 13 01', true, '2022-06-10'),
  ('11111111-0000-0000-0000-000000000014','Romain','Hoffmann','president',         'romain.hoffmann@flh.lu',      '+352 621 11 14 01', true, '2021-01-15'),
  ('11111111-0000-0000-0000-000000000015','Charel','Stelmes', 'president',         'charel.stelmes@flgym.lu',     '+352 621 11 15 01', true, '2019-10-01');

-- ============================================================================
-- CLUB_MEMBERS (nouveau — migration 14)
-- 1 président par club pour les 15 premiers clubs
-- ============================================================================
...
SELECT c.id,
       ...
       true,
       (DATE '2020-01-01' + ((row_number() OVER (ORDER BY c.name))::int * 30))::date
FROM public.clubs c;
...
SELECT c.id,
       ...
       true,
       (DATE '2021-01-01' + ((row_number() OVER (ORDER BY c.name))::int * 21))::date
FROM public.clubs c;

-- ============================================================================
-- LOGOS & PHOTOS (entités) — basé sur 23_seed_entity_images.sql corrigé
-- Federations.acronym (et non short_name), clubs sans acronym → fallback nom.
-- ============================================================================
...
-- ============================================================================
-- DÉMO contrainte 24 : laisser quelques clubs sans fédération
-- (utile pour tester le filtre "Sans fédération")
-- ============================================================================
UPDATE public.clubs SET federation_id = NULL
WHERE id IN (
...
-- ============================================================================
-- MESSAGES (ex-09_seed_messages.sql) — re-exécuté hors transaction principale
-- ============================================================================
BEGIN;
